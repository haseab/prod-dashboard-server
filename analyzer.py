...
class Analyzer:
    def __init__(self):
        self.unplanned = GoogleCalendar('599p0ig3avbm3svucltdqqkh8c@group.calendar.google.com')
...
actual slow (hours)    : {round(actual_slow_hours, 3)}
    ...
    # Create a DataFrame
        ...
        df = df[~((df['Project'].isin(["Tracking", "Planning", "Eating", "Getting Ready", "Washroom"])) & (df['SecDuration'] < 100))]
